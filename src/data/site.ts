...
export const pinterestWeddingDresses = [
  ...
  },
  {
    ...
    style: "Романтичное",
    material: "Атлас",
    details: ["Корсет", "Открытые плечи"],
    availability: "Под заказ",
    description: "Нежный силуэт с корсетной посадкой и мягкими линиями.",
  },
  {
    id: "wedding-belle",
    title: "Belle",
    ...
    style: "Классика",
    material: "Органза",
    details: ["Объемная юбка", "Шлейф"],
    availability: "Индивидуальный пошив",
    description: "Торжественная пышность и безупречная посадка.",
  },
  {
    id: "wedding-claire",
    title: "Claire",
    ...
    style: "Simple bride",
    material: "Крепсатин",
    details: ["Без бретелей", "Чистая линия"],
    availability: "Под заказ",
    description: "Лаконичный силуэт для современной невесты.",
  },
  {
    id: "wedding-dawn",
    title: "Dawn",
    ...
    details: ["Открытая спина", "Расклёш от колена"],
    availability: "Под заказ",
    description: "Изысканный силуэт с акцентом на линию спины.",
  },
  {
    id: "wedding-eden",
    title: "Eden",
    ...
    silhouette: "А-силуэт",
    style: "Романтичное",
    material: "Фатин / сатин",
    details: ["Кружево", "Корсет", "Шлейф"],
    availability: "Индивидуальный пошив",
    description: "Кружево и фатин — воздушный образ для самого важного дня.",
  },
  {
    id: "wedding-faye",
    title: "Faye",
    ...
    style: "Минимализм",
    material: "Сатин",
    details: ["Корсет", "Без бретелей"],
    availability: "Под заказ",
    description: "Чистые линии и точная посадка без лишних деталей.",
  },
  {
    id: "wedding-grace",
    title: "Grace",
    ...
    details: ["Открытые плечи", "Корсет", "Шлейф"],
    availability: "Под заказ",
    description: "Классический bridal-образ с акцентом на талии.",
  },
  {
    id: "wedding-haven",
    title: "Haven",
    ...
    style: "Романтичное",
    material: "Микадо",
    details: ["Объемная юбка", "Закрытый верх", "Пуговицы"],
    availability: "Индивидуальный пошив",
    description: "Пышность и структура — торжественный образ принцессы.",
  },
  {
    id: "wedding-isla",
    title: "Isla",
    ...
    style: "Simple bride",
    material: "Шифон",
    details: ["Тонкие бретели", "Боковой разрез"],
    availability: "Под заказ",
    description: "Воздушный шифон и свободный силуэт для лёгкой свадьбы.",
  },
  {
    id: "wedding-june",
    title: "June",
    ...
    style: "Элегантное",
    material: "Крепсатин",
    details: ["Корсет", "V-образный вырез"],
    availability: "Под заказ",
    description: "Элегантный V-вырез и корсетная посадка подчёркивают фигуру.",
  },
  {
    id: "wedding-kaia",
    title: "Kaia",
    ...
    style: "Элегантное",
    material: "Duchess satin",
    details: ["Длинный рукав", "Посадка по фигуре"],
    availability: "Под заказ",
    description: "Длинный рукав и облегающий силуэт — утончённый образ.",
  },
  {
    id: "wedding-lyra",
    title: "Lyra",
    ...
    style: "Классика",
    material: "Сатин",
    details: ["Корсет", "Закрытый верх", "Шлейф"],
    availability: "Под заказ",
    description: "Классический закрытый лиф и мягкий атласный шлейф.",
  },
  {
    id: "wedding-mora",
    title: "Mora",
    ...
    style: "Романтичное",
    material: "Органза / кружево",
    details: ["Кружево", "Объемная юбка", "Открытые плечи"],
    availability: "Индивидуальный пошив",
    description: "Кружевные детали и пышная юбка — образ нежной невесты.",
  },
  {
    id: "wedding-nala",
    title: "Nala",
    price: "от 850 BYN",
    image: "/dresses/wedding/wedding-34.jpeg",
    silhouette: "Прямое",
    style: "Минимализм",
    material: "Атлас",
    details: ["Без бретелей", "Разрез"],
    availability: "Под заказ",
    description: "Современный минимализм с акцентным разрезом.",
  },
  {
    id: "wedding-oona",
    title: "Oona",
    ...
    style: "Классика",
    material: "Duchess satin",
    details: ["Корсет", "V-вырез на спине", "Шлейф", "Жемчуг"],
    availability: "Индивидуальный пошив",
    description: "Премиальный образ с жемчужными деталями и роскошным атласом duchess.",
  },
] as const;

export const pinterestEveningDresses = [
  { id: "evening-mira",    title: "Mira",    price: "от 250 BYN", image: "/dresses/evening/evening-1.jpeg",  color: "Пудровый",   length: "В пол",     style: "Slip silhouette", material: "Натуральный шелк",   details: ["Драпировка", "Открытые плечи"],    description: "Натуральный шелк дышит и красиво струится — мягкий liquid shine без лишнего блеска, effortless glamour." },
  { id: "evening-alba",    title: "Alba",    price: "от 380 BYN", image: "/dresses/evening/evening-2.jpeg",  color: "Молочный",   length: "Миди",      style: "Минимализм",      material: "Шелк + модал",      details: ["Корсет", "Чистый верх"],           description: "Модал делает посадку мягкой, шелк добавляет глубину и лёгкое сияние — couture femininity." },
  { id: "evening-nova",    title: "Nova",    price: "от 700 BYN", image: "/dresses/evening/evening-3.jpeg",  color: "Бордо",      length: "В пол",     style: "Statement",       material: "Натуральный шелк",   details: ["Длинный рукав", "Квадратный вырез"], description: "Шелк с liquid shine effect ловит свет и образует глубокие складки — cinematic femme fatale." },
  { id: "evening-luna",    title: "Luna",    price: "от 550 BYN", image: "/dresses/evening/evening-4.jpeg",  color: "Шампань",    length: "В пол",     style: "Liquid satin",    material: "Натуральный сатин",  details: ["Мягкий блеск", "Тонкая линия"],    description: "Натуральный сатин создаёт гладкую отражающую поверхность и дорогую текстуру — Hollywood couture." },
  { id: "evening-stella",  title: "Stella",  price: "от 320 BYN", image: "/dresses/evening/evening-5.jpeg",  color: "Голубой",    length: "В пол",     style: "A-line",          material: "Модал + шелк",       details: ["Закрытая линия", "Мягкая юбка"],   description: "Модал не выглядит тяжёлым, шелк добавляет глубину цвета и деликатное сияние — luxury evening elegance." },
  { id: "evening-rose",    title: "Rose",    price: "от 290 BYN", image: "/dresses/evening/evening-6.jpeg",  color: "Розовый",    length: "Макси",     style: "Layered gown",    material: "Натуральный шелк",   details: ["Открытые плечи", "Объёмная юбка"], description: "Натуральный шелк даёт многослойной юбке лёгкость и движение — feminine statement couture." },
  { id: "evening-carmen",  title: "Carmen",  price: "от 450 BYN", image: "/dresses/evening/evening-7.jpeg",  color: "Марсала",    length: "В пол",     style: "Drop waist",      material: "Модал + пайетки",    details: ["Разрез", "Открытые плечи"],        description: "Модал пластичен и невероятно мягкий, а мелкие пайетки создают shimmer effect без перегруза — romantic couture." },
  { id: "evening-jade",    title: "Jade",    price: "от 410 BYN", image: "/dresses/evening/evening-8.jpeg",  color: "Зелёный",    length: "В пол",     style: "Architectural",   material: "Шелк + лен",         details: ["Корсет", "Разрез"],                description: "Лен добавляет структуру и дорогую матовость, шелк даёт мягкое сияние — modern couture editorial." },
  { id: "evening-celeste", title: "Celeste", price: "от 480 BYN", image: "/dresses/evening/evening-9.jpeg",  color: "Голубой",    length: "В пол",     style: "Trumpet",         material: "Хлопок + сатин",     details: ["Корсет", "Шлейф"],                 description: "Хлопок делает платье комфортным и живым, сатин даёт мягкое свечение и luxury texture — modern evening." },
  { id: "evening-amber",   title: "Amber",   price: "от 350 BYN", image: "/dresses/evening/evening-10.jpeg", color: "Шампань",    length: "Миди",      style: "Fit-and-flare",   material: "Модал + пайетки",    details: ["Без бретелей", "Shimmer"],         description: "Натуральный модал невероятно мягкий и пластичный, деликатные пайетки создают дорогой shimmer — romantic glamour." },
  ...
  { id: "evening-viva",    title: "Viva",    price: "от 440 BYN", image: "/dresses/evening/evening-32.jpeg", color: "Розовый",    length: "В пол",     style: "Романтичное",     material: "Шифон",    details: ["Открытые плечи", "Корсет"],        description: "Нежный розовый с корсетной посадкой — романтичный образ для вечера." },
] as const;
...
export const corsetLooks = [
  ...
  { title: "Pearl Edit",      text: "Ivory корсет со шнуровкой — предметная съёмка с жемчугом.",      image: "/corsets/corset-20.jpeg" },
  { title: "White Lace",      text: "Кружевной корсет с пышными деталями — bridal настроение.",       image: "/corsets/corset-21.jpeg" },
