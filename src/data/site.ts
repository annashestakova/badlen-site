...
export const pinterestEveningDresses = [
  {
    ...
    style: "Satin evening",
    material: "Сатин",
    details: ["Драпировка", "Открытые плечи"],
    description: "Мягкое вечернее платье для выпускного, ужина или события.",
  },
  {
    id: "evening-alba",
    title: "Alba",
    ...
    style: "Минимализм",
    material: "Сатин",
    details: ["Корсет", "Чистый верх"],
    description: "Лаконичный образ с корсетной архитектурой.",
  },
  {
    id: "evening-nova",
    title: "Nova",
    ...
    length: "В пол",
    style: "Statement",
    material: "Шелковистый сатин",
    details: ["Разрез", "Акцентный цвет"],
    description: "Платье для яркого выхода с минимумом декора.",
  },
  {
    id: "evening-luna",
    title: "Luna",
    ...
    style: "Liquid satin",
    material: "Сатин",
    details: ["Мягкий блеск", "Тонкая линия"],
    description: "Скользящий силуэт без визуальной тяжести.",
  },
  {
    id: "evening-stella",
    title: "Stella",
    ...
    color: "Графит",
    length: "Миди / макси",
    style: "Evening classic",
    material: "Сатин",
    details: ["Закрытая линия", "Мягкая юбка"],
    description: "Спокойная вечерняя база под выпускной или ужин.",
  },
] as const;
...
export const corsetLooks = [
  ...
  {
    title: "Black",
    text: "Контрастный корсет с более сильным fashion-настроением и драматикой.",
    image: "/corsets/corset-6.jpeg",
  },
  {
    title: "Lace",
    text: "Кружево и полупрозрачные фактуры для тонкой bridal-эстетики.",
    image: "/corsets/corset-14.jpeg",
  },
  {
    title: "Editorial",
    text: "Акцентные силуэты и фактурные ткани для съемок и выразительных образов.",
    image: "/corsets/corset-23.jpeg",
  },
] as const;
