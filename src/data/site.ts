...
export const corsetLooks = [
  {
    title: "Ivory Satin",
    text: "Атласный корсет с пышными бантами и кнопочной планкой — нежная классика BADLEN.",
    image: "/corsets/corset-25.jpeg",
  },
  {
    title: "White Classic",
    text: "Чистый белый корсет со шнуровкой — универсальная база для свадьбы и вечернего образа.",
    image: "/corsets/corset-30.jpeg",
  },
  {
    title: "Pink Bow",
    text: "Пудровый корсет с завязками на плечах — мягкое женственное настроение.",
    image: "/corsets/corset-35.jpeg",
  },
  {
    title: "Cream Edit",
    text: "Кремовый корсет с деталями — для тех, кто ценит спокойный и выверенный образ.",
    image: "/corsets/corset-40.jpeg",
  },
  {
    title: "Black Rose",
    text: "Чёрный атласный корсет с цветком — вечерний акцент для смелого образа.",
    image: "/corsets/corset-45.jpeg",
  },
  {
    title: "Floral",
    text: "Флоральный корсет с принтом — весенний образ с завязками на плечах.",
    image: "/corsets/corset-50.jpeg",
  },
] as const;

export const lookbookPhotos = [
  { image: "/corsets/corset-1.jpeg",  mood: "Provence",       text: "Флорал · Корсет · Лён" },
  ...
  { image: "/corsets/corset-18.jpeg", mood: "Soft Ivory",     text: "Ivory · Мягкий · Образ" },
  { image: "/corsets/corset-19.jpeg", mood: "Bohème",         text: "Бохо · Корсет · Натуральный" },
  { image: "/corsets/corset-20.jpeg", mood: "Pearl Edit",     text: "Ivory · Жемчуг · Детали" },
  { image: "/corsets/corset-21.jpeg", mood: "Feminine",       text: "Корсет · Лёгкий образ" },
  { image: "/corsets/corset-22.jpeg", mood: "Denim Edit",     text: "Деним · Корсет · City" },
  { image: "/corsets/corset-23.jpeg", mood: "Evening Look",   text: "Корсет · Вечерний · BADLEN" },
  { image: "/corsets/corset-24.jpeg", mood: "Atelier",        text: "Ателье · Детали · Образ" },
] as const;
